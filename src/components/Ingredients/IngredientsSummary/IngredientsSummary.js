...
export default function IngredientsSummary(props) {
        ...
        <div style={{ padding: '5px' }}>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            <TableCell className={classes.tableHead}>Ingredients Summary</TableCell>
                    ...
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell align="right" component="th" scope="row">{props.count} ingredients</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell component="th" scope="row">
                                Most Used
                            </TableCell>
                            <TableCell align="right" component="th" scope="row">{props.mostUsed.name + ' (' + props.mostUsed.recipes.length +' times)'}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell component="th" scope="row">
                                Least Used
                            </TableCell>
                            <TableCell align="right" component="th" scope="row">{props.leastUsed.name + ' (' + props.leastUsed.recipes.length +' times)'}</TableCell>
                        </TableRow>
                        </TableBody>
                    </Table>
                    <Table>
